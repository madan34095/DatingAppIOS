...
//        downCount = [[UILabel alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/2-25, 30, 50, 30)];
//        downCount.backgroundColor = [UIColor clearColor];
//        downCount.textAlignment = NSTextAlignmentCenter;
//        downCount.textColor = [UIColor whiteColor];
//        downCount.numberOfLines = 0;
//        downCount.font = [UIFont boldSystemFontOfSize:15];
//        leftTime = 15;
//        downCount.text = [NSString stringWithFormat:@"00:%02d", leftTime];
