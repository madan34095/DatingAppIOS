...
class LZViewPagerHeader: UIScrollView {
    ...
    private lazy var containerView: UIView = {
        ...
        v.backgroundColor = UIColor(hexString: "#D9E6EB")
        return v
    }()
    ...
    private func buttonXLeading(for index: Int) -> CGFloat {
        ...
        var offest: CGFloat = (UIScreen.main.bounds.width - 240) / 2
        for i in 0..<index {
    ...
    private func setUpIndicator() {
        ...
        self.indicatorView.backgroundColor = Config.TabUnderLineColor
