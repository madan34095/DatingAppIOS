...
- (void)jsq_configureFlowLayout
{
    ...
    self.sectionInset = UIEdgeInsetsMake(10.0f, 4.0f, 0.0f, 4.0f);
    self.minimumLineSpacing = 4.0f;
    
    _messageBubbleFont = [[UIFont preferredFontForTextStyle:UIFontTextStyleBody] fontWithSize:17];
    ...
    _messageBubbleTextViewFrameInsets = UIEdgeInsetsMake(0.0f, 6.0f, 0.0f, 6.0f);
...
{
    JSQMessage *messageItem = (JSQMessage *)[self.collectionView.dataSource collectionView:self.collectionView
                                                      messageDataForItemAtIndexPath:indexPath];
