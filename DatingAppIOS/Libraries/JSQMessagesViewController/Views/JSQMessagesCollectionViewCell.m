...
@property (weak, nonatomic) IBOutlet UIView *cellTopBack;
...
@property (weak, nonatomic) IBOutlet JSQMessagesLabel *reportText;
...
- (void)awakeFromNib
{
    ...
    self.cellTopBack.backgroundColor = [UIColor grayColor];
    self.cellTopBack.layer.cornerRadius = 5;
    self.cellTopBack.clipsToBounds = YES;
    ...
    self.cellBottomLabel.textColor = [UIColor blueColor];
    
    self.cellSideLabel.font = [UIFont systemFontOfSize:10.0f];
    self.cellSideLabel.textColor = [UIColor grayColor];
...
- (void)setBackgroundColor:(UIColor *)backgroundColor
{
    ...
    self.cellTopLabel.backgroundColor = [UIColor grayColor];
    ...
    self.reportText.backgroundColor = backgroundColor;
}
