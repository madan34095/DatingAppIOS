...
- (JSQMessagesBubbleImage *)adminMessagesBubbleImageWithColor:(UIImage *)bubleImage color: (UIColor *)color
{
    NSParameterAssert(color != nil);
    
    UIImage *normalBubble = [bubleImage jsq_imageMaskedWithColor:color];
    UIImage *highlightedBubble = [bubleImage jsq_imageMaskedWithColor:[color jsq_colorByDarkeningColorWithValue:0.12f]];
