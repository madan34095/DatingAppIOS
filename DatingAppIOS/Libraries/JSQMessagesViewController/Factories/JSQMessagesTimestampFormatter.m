...
//    
//    if ([relativeDate isEqualToString:@"Today"]) {
//        relativeDate = @"今日";
//    }else if ([relativeDate isEqualToString:@"Yesterday"]) {
//        relativeDate = @"昨日";
//    }else if ([relativeDate isEqualToString:@"Last week"]) {
//        relativeDate = @"先週";
//    }else if ([relativeDate isEqualToString:@"Last month"]) {
//        relativeDate = @"去年";
//    }
