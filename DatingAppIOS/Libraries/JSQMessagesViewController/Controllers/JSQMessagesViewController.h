...
@interface JSQMessagesViewController : UIViewController <JSQMessagesCollectionViewDataSource,
                                                         ...
                                                         MediaButtonMenuViewDelegate,
                                                         VoiceRecordToolViewDelegate,
                                                         UITextViewDelegate>

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bottomToolBarHeight;
@property (weak, nonatomic) IBOutlet UIView *bottonToolBarView;
...
@property (copy, nonatomic) NSString *reportCellIdentifier;
/**
 *  The collection view cell identifier to use for dequeuing incoming message collection view cells 
 *  in the collectionView for media messages.
 *
